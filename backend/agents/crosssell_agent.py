...
Identifies coverage gaps and cross-sell opportunities for existing clients
based on their industry, current coverage, and risk profile.
"""
import json
...
class CrossSellAgent:
    """Agent that identifies coverage gaps and cross-sell opportunities."""
    
    def __init__(self, config: Optional[AgentConfig] = None):
        self.config = config or AgentConfig.from_env()
        self.agent_config = AGENT_CONFIGS["cross_sell"]
